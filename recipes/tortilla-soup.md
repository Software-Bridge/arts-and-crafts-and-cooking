...
- Corn/Canola oil
- (Optional) Hot sauces particularly a combination of Cholula and a Sriracha sauce. 
...
- Add all soup base ingredients in pan.
- (Optional) If adding hot sauce, add in 2-4 shakes worth depending on your heat preference
...
A key step is using the immersion blender to help thicken the broth.  However a typical such blender has a metal edge and will mess up a ceramic or stick-proof pan.  I like to cook in ceramic so when I'm ready to blend, I pour the whole soup into a large old metal pan, blend in that, then pour that back into the ceramic.  

**Corn on the Cob vs. Kernels**

If you include corn on the cob you want to add that in a bit earlier than some of the vegetables.  I like how much flavor the is absorbed in the cob that you get when you eat it, however others I make this soup for don't like the mess of eating it that way so I often just make the soup with kernels.  If using kernels, I prefer frozen corn, which can be added right at the end with the chicken. 

**Noodles**

I like to add noodles, but every time I've included them in the cooking process I either end up with them way overcooked in the soup, or else they absorb the rest of the soup when we save it for later.  
...
<img width="515" alt="Screenshot 2025-11-04 at 6 58 49 PM" src="https://github.com/user-attachments/assets/0c62810a-cec4-40ba-b314-d114be54d224" />

**Another Serving Attempt**

<img width="515" alt="Screenshot 2025-11-04 at 6 58 49 PM" src="https://github.com/user-attachments/assets/970a96ea-9558-4703-95c1-eba9bd9a7721" />

Recipe by Daniel A Allard
